        ...
        <div className="flex justify-center">
          <div className="w-full max-w-[500px] rounded-[32px] bg-white px-14 py-16 shadow-xl">
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-8 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-500 py-4 font-semibold text-white shadow-lg transition hover:bg-brand-600"
            >
              {isLoading ? (
                <>
